local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/orangefireflies.xml"),
	Asset("IMAGE", "images/inventoryimages/orangefireflies.tex"),
}
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/orangefireflies.xml"
...
return Prefab("common/inventory/orangefireflies", fn, assets,prefabs)
