local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/bluefireflies.xml"),
	Asset("IMAGE", "images/inventoryimages/bluefireflies.tex"),
}
...
local function fn()
    ...
    inst.Light:SetColour(10/255, 75/255, 255/255)--紫红色bluefireflies
    inst.Light:SetIntensity(0)
    inst.Light:Enable(false)
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/bluefireflies.xml"
...
return Prefab("common/inventory/bluefireflies", fn, assets,prefabs)
