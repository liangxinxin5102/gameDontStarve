...
local wetpouch =
{
    loottable =
    {
        ...
        antliontrinket = 0,
        smallmeat = 0.1, -- 小肉
        cookedsmallmeat = 0.1, -- 烤小肉
        plantmeat_cooked = 0.1, -- 烤食人花肉
        trinket_26 = 1, -- 玩具薯杯
        TOOLS_blueprint = .05,
        LIGHT_blueprint = .05,
	    ...
	    meat = 0.1,
	    twigs = 1,         --树枝
	 --   krampus_sack =0.01, --坎普斯背包
	    krampus_sack =0.001, --坎普斯背包
	    silk = 1,          --蛛网
	    redgem = 0.6,       --红宝石
	    goldnugget = 0.9,    --金子
	    pigguard = 0.01,     --猪人守卫
	    smallmeat_dried = 0.9,  --小肉干
	    meat_dried = 0.9,    --大肉干
	  --  frog = 0.05,         --青蛙
	    eel = 0.05,          --鳗鱼
		yellowgem = 0.5,    --黄宝石
		...
		purplegem = 0.5,    --紫宝石
		bluegem = 0.6,      --蓝宝石
		opalpreciousgem = 0.9, --彩虹宝石
		newweapons = 0.01,
		
		hj_wings1 = 0.0001,---翅膀
	    hj_wings2 = 0.0001,---翅膀
	    hj_wings3 = 0.000001,---翅膀
	    hj_wings4 = 0.0001,---翅膀
	    hj_wings5 = 0.0000005,---翅膀
	    cbdz0 = 0.00001,---翅膀
	    cbdz1 = 0.00001,---翅膀
	    cbdz2 = 0.00001,---翅膀
	    ly_yc002 = 0.003,---翅膀
	    ly_yc001 = 0.00003,---翅膀
	  --  hj_pokeball = 0.005,---精灵球
