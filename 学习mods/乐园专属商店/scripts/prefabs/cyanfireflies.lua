local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/cyanfireflies.xml"),
	Asset("IMAGE", "images/inventoryimages/cyanfireflies.tex"),
}
...
local function fn()
    ...
    inst.Light:SetColour(0/255, 255/255, 255/255)--cyanfireflies青色
    inst.Light:SetIntensity(0)
    inst.Light:Enable(false)
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/cyanfireflies.xml"
...
return Prefab("common/inventory/cyanfireflies", fn, assets,prefabs)
