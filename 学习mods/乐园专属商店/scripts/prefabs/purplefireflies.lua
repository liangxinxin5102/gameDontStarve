local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/purplefireflies.xml"),
	Asset("IMAGE", "images/inventoryimages/purplefireflies.tex"),
}
...
local function fn()
    ...
    inst.Light:SetColour(180/255, 0/255, 255/255)--紫
    inst.Light:SetIntensity(0)
    inst.Light:Enable(false)
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/purplefireflies.xml"
...
return Prefab("common/inventory/purplefireflies", fn, assets,prefabs)
