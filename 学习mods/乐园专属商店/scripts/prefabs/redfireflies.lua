local assets =
{
	...
	Asset("ATLAS", "images/inventoryimages/redfireflies.xml"),
	Asset("IMAGE", "images/inventoryimages/redfireflies.tex"),
}
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/redfireflies.xml"
...
return Prefab("common/inventory/redfireflies", fn, assets,prefabs)
