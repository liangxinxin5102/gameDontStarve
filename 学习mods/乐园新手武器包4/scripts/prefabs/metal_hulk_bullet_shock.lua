...
local COLOUR_ENVELOPE_NAME = "shock_smoke_colourenvelope"
local SCALE_ENVELOPE_NAME = "shock_smoke_scaleenvelope"

local LIGHTNING_TEXTURE = resolvefilepath("fx/ly_lightningsheet.tex") 
local LIGHTNING_COLOUR_ENVELOPE_NAME = "shock_lightning_colourenvelope"
local LIGHTNING_SCALE_ENVELOPE_NAME = "shock_lightning_scaleenvelope"
...
return Prefab("metal_hulk_bullet_shock", fn, assets)
