...
-- Changes the visual light range and heat output which would require
-- duplicating significant chunks of code to change in a modmain.
-- Updated for Revision 74452 2013-03-12_14-18-42 (A Little Rain Must Fall)
--
print("Loading custom campfire prefab override")
    ...
    inst.components.fueled:SetSectionCallback(
        function(section)
            if section == 0 then
                ...
                inst.components.fueled.rate = 1
-- MOD --                
                local ranges = {2,3,4,5}		--Default: {1,2,3,4}
                local output = {3,6,9,12}		--Default: {2,5,5,10}
-- /MOD --
