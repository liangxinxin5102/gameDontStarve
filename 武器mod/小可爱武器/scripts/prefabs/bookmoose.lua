...
local function MakeBook(def)
	...
	for i, v in ipairs(book_defs) do
		...
		local function fn()
			...
			inst.AnimState:SetBank("bookmoose")
            inst.AnimState:SetBuild("bookmoose")
	       ...
	       inst.components.inventoryitem.atlasname = "images/inventoryimages/bookmoose.xml"
