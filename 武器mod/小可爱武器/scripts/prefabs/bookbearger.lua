local assets =
{
Asset("ANIM", "anim/bookbearger.zip"),
...
local function MakeBook(def)
	...
	for i, v in ipairs(book_defs) do
		...
		local function fn()
			...
			inst.AnimState:SetBank("bookbearger")
            inst.AnimState:SetBuild("bookbearger")
	       ...
	       inst.components.inventoryitem.atlasname = "images/inventoryimages/bookbearger.xml"
